...
export default function PremiumSubscription() {
  const { user, isPremium, upgradeToPremium, loading } = useAuth();
  ...
  const handleUpgradeClick = () => {
    // This now only gets called if user is logged in
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto max-w-2xl mt-12">
              <Card className="shadow-lg border-primary border-2">
                  ...
                  <CardFooter>
                      {user ? (
                        <Button size="lg" className="w-full font-semibold text-lg" onClick={handleUpgradeClick} disabled={loading}>
